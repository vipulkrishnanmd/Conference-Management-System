...
<%String msg=(String)request.getAttribute("msg"); %>
 ...
 <%} %>
 <br><br>
<form name="createNewConference" method="post" action="Display" enctype="multipart/form-data" >
...
<tr>
	<td>Keywords(with comma)</td>
	<td><input type="Textbox" name="keywords" id="keywords" required></td>
 ...
 <tr>
                    <td>Paper</td>
                    <td><input type="file" name="file" id="file" size="50" required/ accept=".pdf,.docx, .doc"></td>
</tr>
...
<tr>
	 ...
	 <input type="hidden" name="fun" value="createNewPaper">
