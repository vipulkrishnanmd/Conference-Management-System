...
<select placeholder='Occupation' name="occupation">
  <option value="Student">I am a Student</option>
  <option value="Lecturer/Tutor">I am a Lecturer/Tutor</option>
  <option value="Other">I am none of the above</option>
</select>
<input type="text" placeholder="Expetrise(Seperate with Comma)" name="expertise" required/>
<input type="password" placeholder="Password" name="pwd" value="" required/>
 <input type="hidden" name="fun" value="signup"/>
